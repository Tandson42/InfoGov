...
/**
 * Form Request para atualização de departamento
 * 
 * Valida os campos necessários para atualizar um departamento existente
 */
class UpdateDepartmentRequest extends FormRequest
{
    ...
    /**
     * Regras de validação para atualizar departamento
     *
